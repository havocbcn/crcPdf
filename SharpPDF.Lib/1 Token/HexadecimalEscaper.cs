...
namespace SharpPDF.Lib
{
    public class HexadecimalEscaper
    {
        ...
        public string GetValue(string asciiHexadecimal) => ConvertHexToString(FilterNonHexCharAndUpperCase(asciiHexadecimal));

        private int GetHexVal(int val) => val - (val <= '9' ? '0' : 'A'-10);
    }
}